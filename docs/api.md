...
| Page | Contents |
|------|----------|
| [Functions](api-functions.md) | `compile_logic`, `logic_to_loss`, `consistency_report` |
| [CompiledExpression](api-compiled-expression.md) | Per-batch evaluation, partial binding |
